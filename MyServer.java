...
{
if(s==null)
 	{JOptionPane.showMessageDialog(chatWindow,"you r not logged in. plz login first"); return;}
try{
...
if(s!=null)
{
JOptionPane.showMessageDialog(chatWindow,"YOU r logged out right now. ","Exit",JOptionPane.INFORMATION_MESSAGE);
logoutSession();
}
System.exit(0);
}
